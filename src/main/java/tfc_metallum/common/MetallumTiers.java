...
public final class MetallumTiers {
    ...
    public static final Tier BORON = register("boron", List.of(WROUGHT_IRON, COMPRESSED_IRON), List.of(Tiers.DIAMOND), MetallumTags.Blocks.NEEDS_BORON_TOOLS, 3, 6200, 15f, 5.9f, 28);
    ...
    public static final Tier PEWTER = register("pewter", List.of(WROUGHT_IRON, COMPRESSED_IRON, URANIUM), List.of(Tiers.DIAMOND), MetallumTags.Blocks.NEEDS_PEWTER_TOOLS, 3, 4900, 9.9f, 4.7f, 23);
    ...
    public static final Tier TITANIUM = register("titanium", WROUGHT_IRON, Tiers.DIAMOND, MetallumTags.Blocks.NEEDS_TITANIUM_TOOLS, 3, 3900, 10.9f, 5.5f, 20);
    public static final Tier THORIUM = register("thorium", TITANIUM, Tiers.DIAMOND, MetallumTags.Blocks.NEEDS_THORIUM_TOOLS, 3, 3900, 11.5f, 5.2f, 12);
    public static final Tier TUNGSTEN = register("tungsten", THORIUM, Tiers.DIAMOND, MetallumTags.Blocks.NEEDS_TUNGSTEN_TOOLS, 3, 4000, 11f, 5.8f, 18);
