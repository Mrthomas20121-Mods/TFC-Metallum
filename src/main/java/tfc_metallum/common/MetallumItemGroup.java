...
public class MetallumItemGroup extends CreativeModeTab {
    ...
    public static final CreativeModeTab METAL = new MetallumItemGroup("metals", () -> new ItemStack((ItemLike)((RegistryObject<?>)((Map<?, ?>) MetallumItems.METAL_ITEMS.get(MetallumMetal.ALUMINUM)).get(MetallumMetal.ItemType.INGOT)).get()));
